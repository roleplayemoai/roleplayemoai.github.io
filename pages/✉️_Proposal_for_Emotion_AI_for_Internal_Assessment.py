...
email_sender_email = "mahadi.gupta@emoai.com"
email_subject = "Proposal for Emotion AI for Internal Assessment"
email_content = """\
Hi,

Hope you are well! I'm with the sales and marketing team, and I was recently contacted by a leading IT company interested in integrating our Emotion AI API into an internal tool for monitoring employee performance and mental well-being. The idea is to help employees stay focused and maintain a healthy mental state by analyzing their emotional cues during work and meetings. They offered to highlight our company as a collaborator in both their internal and external communications, which could be a great opportunity to increase our visibility.
