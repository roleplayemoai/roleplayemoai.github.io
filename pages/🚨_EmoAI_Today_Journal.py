...
def main():
    ...
    st.markdown(
        ...
        <p>"This crosses a fundamental line between professional oversight and invasive surveillance," said one senior developer at the company. "Many of us feel this technology could create a hostile work environment where we're constantly anxious about being judged not just on our work output, but on our facial expressions during meetings."</p>
